  ...
  return (
    <div className='explore-card cur-po'>
      <div className="explore-card-cover">
        ...
        {proOff&& <div className='pro-off'>{deliveryTime}</div>}
      ...
      <div className='res-row'>
        ...
        {rating&&(
          <div className='res-rating absolute-center'>
            {rating}<AiFillStar className='absolute-center'/>
          </div>
        )}
      </div>
      <div className="res-row">
      ...
      {bottomContainers.length>0&&<div>
        ...
        <div className='explore-bottom'>
          <img src={bottomContainers[0]?.image?.url} alt=""  style={{height:"18px"}}/><div className='res-bottom-text'>{bottomContainers[0]?.text}</div></div>     
